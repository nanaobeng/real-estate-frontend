...
import { addDeveloperAvailableProperty} from '../APIs'
import { LoadingOverlay, Button, Group } from '@mantine/core';
const DevelopersAvailablePropertiesCreateForm = () => {
    ...
    const submitRequest = () => {
        ...
        addDeveloperAvailableProperty(formData)
            .then((data:any) => {
                if (data.error) {
                    setError(data.error)
...
export default DevelopersAvailablePropertiesCreateForm