...
import {getPropertyRequests,getPropertyRequest,propertyStatus} from './APIs'
...
const ClientInquiries  = () => {
 ...
 <div className="row px-0">
                         <div className="col-12 px-0 text-center" style={{backgroundColor:'#F5B221',height:'75px',borderRadius:'20px',paddingTop:'15px'}}>
                              <b style={{fontSize:'30px'}}>Client Inquiries</b>
                         </div>
                     </div>
                        ...
                        return(
                            ...
                            <div className='col-lg-6 col-md-12' key={i}>
                                    <div className='row'>
                                        ...
                                        <div className='col-12'>
                                        <b style={{color:'grey',fontSize:'1.3vh'}}>Location :</b> {item.location}
                                        </div>
                                        ...
                                        <span onClick={()=>{getSingleRequest(item.property_id)}}className="btn btn-sm btn-outline-primary" style={{fontWeight:"bold",fontSize:'1.3vh'}}>View Inquiry</span>
                                        </div>
                                        <div className='col-6 pt-1 text-right'>
                                        <Popconfirm
    title="Are you sure you want mark this request as read?"
    onConfirm={()=> changeStatus(item.property_id)}
